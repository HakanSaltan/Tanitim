...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    veriGetir: function veriGetir() {
      ...
      axios.get('/admin/sayfalarApi').then(function (response) {
        _this.sayfalar = response.data;
      });
    },
    modalAc: function modalAc() {
      this.$modal.show('yeni-sayfa-ekle');
    },
    sayfaEkle: function sayfaEkle() {
      var _this2 = this;
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("modal", { attrs: { name: "yeni-sayfa-ekle", height: "auto" } }, [
        _c("div", { staticClass: "container" }, [
          _c("h1", { staticClass: "display-3" }, [_vm._v("Yeni Sayfa Ekle")]),
          _c("br"),
          _vm._v(" "),
          _c("form", [
              ...
              _c("div", { staticClass: "col-md-12" }, [
                _c("div", { staticClass: "form-group" }, [
                  _c("input", {
                    ...
                    domProps: { value: _vm.sayfaAdi },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.sayfaAdi = $event.target.value
                      }
                    }
                  })
                ])
            ...
            _c("div", { staticClass: "row" }, [
              _c("div", { staticClass: "col-md-12" }, [
                _c("div", { staticClass: "form-group" }, [
                  _c("label", { attrs: { for: "icerik" } }, [
                    _vm._v("Sayfa İçeriği")
                  ]),
                  _vm._v(" "),
                  _c("textarea", {
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.sayfaIcerik,
                        expression: "sayfaIcerik"
                      }
                    ],
                    attrs: { name: "", id: "icerik", cols: "60", rows: "10" },
                    domProps: { value: _vm.sayfaIcerik },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.sayfaIcerik = $event.target.value
                      }
                    }
                  })
                ])
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.sayfaMetaAciklamasi,
                        expression: "sayfaMetaAciklamasi"
                      }
                    ],
                    staticClass: "form-control",
                    attrs: {
                      type: "text",
                      id: "exampleFormControlInput1",
                      placeholder: "Sayfa Meta Açıklaması"
                    },
                    domProps: { value: _vm.sayfaMetaAciklamasi },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.sayfaMetaAciklamasi = $event.target.value
                      }
                    }
                  })
                ])
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.sayfaAnahtarKelimeler,
                        expression: "sayfaAnahtarKelimeler"
                      }
                    ],
                    staticClass: "form-control",
                    attrs: {
                      ...
                      id: "exampleFormControlInput1",
                      placeholder:
                        "Sayfa Meta Anahtar Kelimeleri (Meta Keywords)"
                    },
                    domProps: { value: _vm.sayfaAnahtarKelimeler },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.sayfaAnahtarKelimeler = $event.target.value
                      }
                    }
                  })
                ])
                  ...
                  "select",
                  {
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.sayfaDurumu,
                        expression: "sayfaDurumu"
                      }
                    ],
                    ...
                    on: {
                      change: function($event) {
                        ...
                        _vm.sayfaDurumu = $event.target.multiple
                          ? $$selectedVal
                          : $$selectedVal[0]
                      }
                    }
                  ...
                  "select",
                  {
                    ...
                    on: {
                      change: function($event) {
                        ...
                        _vm.sayfaTipi = $event.target.multiple
                          ? $$selectedVal
                          : $$selectedVal[0]
                      }
                    }
      ...
      _c("div", { staticClass: "table-responsive" }, [
        _c("table", { staticClass: "table align-items-center" }, [
          ...
          _c(
            "tbody",
            _vm._l(_vm.sayfalar, function(sayfa) {
              return _c("tr", [
                _c("th", { attrs: { scope: "row" } }, [
                  _c("div", { staticClass: "media align-items-center" }, [
                    _c("div", { staticClass: "media-body" }, [
                      _c("span", { staticClass: "mb-0 text-sm" }, [
                        _vm._v(_vm._s(sayfa.sayfa_basligi))
                      ])
                    ])
                  ])
                ]),
                      ...
                      [
                        _c(
                          "a",
                          {
                            ...
                            attrs: { href: "/admin/sayfa/duzenle/" + sayfa.id }
                          },
                          [_vm._v("Düzenle")]
                        ),
                        _vm._v(" "),
...
/***/ "./resources/js/components/sayfalar.vue":
/*!**********************************************!*\
  !*** ./resources/js/components/sayfalar.vue ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sayfalar_vue_vue_type_template_id_5989f87c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sayfalar.vue?vue&type=template&id=5989f87c& */ "./resources/js/components/sayfalar.vue?vue&type=template&id=5989f87c&");
/* harmony import */ var _sayfalar_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sayfalar.vue?vue&type=script&lang=js& */ "./resources/js/components/sayfalar.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _sayfalar_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _sayfalar_vue_vue_type_template_id_5989f87c___WEBPACK_IMPORTED_MODULE_0__["render"],
  _sayfalar_vue_vue_type_template_id_5989f87c___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/sayfalar.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/sayfalar.vue?vue&type=script&lang=js&":
/*!***********************************************************************!*\
  !*** ./resources/js/components/sayfalar.vue?vue&type=script&lang=js& ***!
  \***********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_sayfalar_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./sayfalar.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/sayfalar.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_sayfalar_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/sayfalar.vue?vue&type=template&id=5989f87c&":
/*!*****************************************************************************!*\
  !*** ./resources/js/components/sayfalar.vue?vue&type=template&id=5989f87c& ***!
  \*****************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_sayfalar_vue_vue_type_template_id_5989f87c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./sayfalar.vue?vue&type=template&id=5989f87c& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/sayfalar.vue?vue&type=template&id=5989f87c&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_sayfalar_vue_vue_type_template_id_5989f87c___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_sayfalar_vue_vue_type_template_id_5989f87c___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
__webpack_require__(/*! /Users/beytullah/Desktop/kodlooper_yazilim/htdocs/Tanitim/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/beytullah/Desktop/kodlooper_yazilim/htdocs/Tanitim/resources/sass/app.scss */"./resources/sass/app.scss");
