            ...
            <div class="container">
                ...
                <form >
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text"  v-model="sayfaUrl" class="form-control" id="exampleFormControlInput1" placeholder="Sayfa Url">
                            </div>
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="col-md-12">
                            <label for="">Menü Durumu</label>
                            <select v-model="menudeGoster" class="custom-control form-select btn-block" aria-label="Default select example">
                                <option selected>Menüde Gösterilsin</option>
                                <option value="aktif">Evet</option>
                                <option value="pasif">Hayır</option>
                            </select>
                        </div>
            ...
            <div class="container">
                ...
                <form >
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text"  v-model="updateData.sayfa_url" class="form-control" id="exampleFormControlInput1" placeholder="Sayfa Url">
                            </div>
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="col-md-12">
                            <label for="">Menü Durumu</label>
                            <select v-model="updateData.menude_goster" class="custom-control form-select btn-block" aria-label="Default select example">
                                <option selected>Menüde Gösterilsin</option>
                                <option value="aktif">Evet</option>
                                <option value="pasif">Hayır</option>
                            </select>
                    ...
                    <tr v-for="sayfa in sayfalar">
                        ...
                        <th scope="row">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    <span class="mb-0 text-sm">{{sayfa.sayfa_url}}</span>
                                </div>
                            </div>
                        </th>
                        <td>
